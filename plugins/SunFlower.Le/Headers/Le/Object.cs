...
public struct Object(uint virtualSegmentSize, uint relocationBase, uint objectFlagsMask, uint pageMap, uint pageMapEntries, uint unknown)
{
    ...
    {
        (ObjectFlagsMask & 0x1000) != 0 ? "16:16" : string.Empty,
        (ObjectFlagsMask & 0x2000) != 0 ? "USE_32" : "USE_16",
        (ObjectFlagsMask & 0x4000) != 0 ? "CONFORMING" : string.Empty,
        (ObjectFlagsMask & 0x20000) != 0 ? "IO_PRIVILEGES" : "DEFAULT_PRIVILEGES"
